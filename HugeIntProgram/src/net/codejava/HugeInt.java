...
{
	// i started out by creating my own List to store digits
    ...
    public int compareTo(HugeInt a) 
    {
        ...
        // here is a static method to sort an ArrayList of HugeInt objects using QuickSort
        public static void quickSort(ArrayList<HugeInt> list) 
        {
        ...
        private static void quickSort(ArrayList<HugeInt> list, int left, int right) 
        {
            if (left < right) 
            {
        ...
        // here is my partition method to partition the ArrayList
        private static int partition(ArrayList<HugeInt> list, int left, int right) 
        {
        ...
        // finally, heres the helper method to swap two elements in the ArrayList
        private static void swap(ArrayList<HugeInt> list, int i, int j) 
        {
        ...
        public static void sort(ArrayList<HugeInt> list) 
        {
            quickSort(list);
        }
